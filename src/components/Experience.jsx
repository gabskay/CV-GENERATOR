...
const Experience = (props) => {
    ...
    const handleExperienceInfo = (e) => {
        ...
        const eduInfo = {
            ...
            task: experienceInfo.mainTask,
            dateFrom: new Date(experienceInfo.dateFrom),
            dateTo: new Date(experienceInfo.dateTo)
        }
        setExperienceInfo({
            company: '',
            position: '',
        ...
        if (experienceInfo.company.trim().length === 0 ||
...
return (
    <div onConfirm={errorHandler}>
        ...
        <form className='forms' onSubmit={handleExperienceInfo}>
            ...
            <input className='input-lg input-info'
                type='text'
                id='company'
            ...
            <input className='input-lg input-info textarea-info'
                type='text'
                id='task'
